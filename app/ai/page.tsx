      ...
      <div className="flex bg-white h-screen">
        <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
          <div>
            <span className="text-2xl font-semibold text-gray-800 md:text-4xl">
              ⏰ AI<span className="ml-2 text-blue-600">Soon</span> ⏰
            </span>
            <h1 className="py-5 text-5xl font-semibold text-gray-800 md:text-6xl">
              Health<span className="ml-2 text-blue-600">Harbor</span>
            </h1>

            <p className="mt-2 text-sm text-gray-500 md:text-lg">
              <a href="https://fontgenerator.org/">Font generator</a>
              <strong></strong>
            </p>
        ...
        <div className="hidden lg:block lg:w-1/2">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/FLWVKOHAO5EGHMIHQ4FXQF7NHU.jpg&w=1200)",
            }}
          >
